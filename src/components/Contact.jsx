      ...
      >
        ...
        >
          <div className="mt-1 text-center">
            <h2 className="text-white text-3xl font-bold">Pooja Jadhav</h2>
          ...
          <div className="flex items-center justify-evenly">
            <label className='flex flex-col'>
              <a href="https://www.linkedin.com/in/pooja7483/" target="_blank" >
                <img
                  src={"/linkedin2.png"}
                  alt="logo"
            ...
            <label className='flex flex-col'>
              <a href="mailto:jpoojas352@gmail.com" target="_blank" >
                <img
                  src={"/email.png"}
                  alt="logo"
                  className="w-16 h-16 object-contain"
